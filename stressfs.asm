...
main(int argc, char *argv[])
{
  ...
  2a:	68 cc 06 00 00       	push   $0x6cc
  2f:	6a 01                	push   $0x1
  31:	e8 dd 03 00 00       	call   413 <printf>
  ...
  6a:	53                   	push   %ebx
  6b:	68 df 06 00 00       	push   $0x6df
  70:	6a 01                	push   $0x1
  72:	e8 9c 03 00 00       	call   413 <printf>
...
//    printf(fd, "%d\n", i);
  ...
  c3:	68 e9 06 00 00       	push   $0x6e9
  c8:	6a 01                	push   $0x1
  ca:	e8 44 03 00 00       	call   413 <printf>
...
putc(int fd, char c)
{
 ...
 37c:	83 ec 1c             	sub    $0x1c,%esp
 37f:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
 382:	6a 01                	push   $0x1
 384:	8d 55 f4             	lea    -0xc(%ebp),%edx
 387:	52                   	push   %edx
 388:	50                   	push   %eax
 389:	e8 3b ff ff ff       	call   2c9 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39c:	89 c7                	mov    %eax,%edi
  ...
  neg = 0;
  if(sgn && xx < 0){
 39e:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 3a2:	0f 95 c3             	setne  %bl
 3a5:	89 d0                	mov    %edx,%eax
 3a7:	c1 e8 1f             	shr    $0x1f,%eax
 3aa:	84 c3                	test   %al,%bl
 3ac:	74 10                	je     3be <printint+0x2b>
    neg = 1;
    x = -xx;
 3ae:	f7 da                	neg    %edx
    neg = 1;
 3b0:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }
 ...
 3bc:	eb 0b                	jmp    3c9 <printint+0x36>
  neg = 0;
 3be:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 3c5:	eb f0                	jmp    3b7 <printint+0x24>
  do{
    buf[i++] = digits[x % base];
 ...
 3d4:	8d 46 01             	lea    0x1(%esi),%eax
 3d7:	0f b6 92 f8 06 00 00 	movzbl 0x6f8(%edx),%edx
 3de:	88 54 35 d8          	mov    %dl,-0x28(%ebp,%esi,1)
  }while((x /= base) != 0);
 3e2:	89 da                	mov    %ebx,%edx
 3e4:	85 db                	test   %ebx,%ebx
 3e6:	75 df                	jne    3c7 <printint+0x34>
 3e8:	89 c3                	mov    %eax,%ebx
  if(neg)
 3ea:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 3ee:	74 16                	je     406 <printint+0x73>
    buf[i++] = '-';
 3f0:	c6 44 05 d8 2d       	movb   $0x2d,-0x28(%ebp,%eax,1)
 3f5:	8d 5e 02             	lea    0x2(%esi),%ebx
 3f8:	eb 0c                	jmp    406 <printint+0x73>

  while(--i >= 0)
    putc(fd, buf[i]);
 3fa:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 3ff:	89 f8                	mov    %edi,%eax
 401:	e8 73 ff ff ff       	call   379 <putc>
  while(--i >= 0)
 406:	83 eb 01             	sub    $0x1,%ebx
 409:	79 ef                	jns    3fa <printint+0x67>
}
...
printf(int fd, const char *fmt, ...)
{
 ...
 433:	e8 41 ff ff ff       	call   379 <putc>
 ...
 44b:	0f 84 23 01 00 00    	je     574 <printf+0x161>
    c = fmt[i] & 0xff;
 ...
 475:	08 d1                	or     %dl,%cl
 477:	75 63                	jne    4dc <printf+0xc9>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 479:	83 f8 73             	cmp    $0x73,%eax
 47c:	0f 84 84 00 00 00    	je     506 <printf+0xf3>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 482:	83 f8 63             	cmp    $0x63,%eax
 485:	0f 84 b7 00 00 00    	je     542 <printf+0x12f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 48b:	83 f8 25             	cmp    $0x25,%eax
 48e:	0f 84 cc 00 00 00    	je     560 <printf+0x14d>
        putc(fd, c);
      } else {
 ...
 49c:	e8 d8 fe ff ff       	call   379 <putc>
        putc(fd, c);
 4a1:	89 fa                	mov    %edi,%edx
 4a3:	8b 45 08             	mov    0x8(%ebp),%eax
 4a6:	e8 ce fe ff ff       	call   379 <putc>
      }
      state = 0;
 4ab:	be 00 00 00 00       	mov    $0x0,%esi
 4b0:	eb 8d                	jmp    43f <printf+0x2c>
        printint(fd, *ap, 10, 1);
 4b2:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 4b5:	8b 17                	mov    (%edi),%edx
 4b7:	83 ec 0c             	sub    $0xc,%esp
 4ba:	6a 01                	push   $0x1
 4bc:	b9 0a 00 00 00       	mov    $0xa,%ecx
 4c1:	8b 45 08             	mov    0x8(%ebp),%eax
 4c4:	e8 ca fe ff ff       	call   393 <printint>
        ap++;
 4c9:	83 c7 04             	add    $0x4,%edi
 4cc:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 4cf:	83 c4 10             	add    $0x10,%esp
      state = 0;
 4d2:	be 00 00 00 00       	mov    $0x0,%esi
 4d7:	e9 63 ff ff ff       	jmp    43f <printf+0x2c>
        printint(fd, *ap, 16, 0);
 ...
 4ee:	e8 a0 fe ff ff       	call   393 <printint>
        ap++;
 ...
 501:	e9 39 ff ff ff       	jmp    43f <printf+0x2c>
        s = (char*)*ap;
 ...
 513:	75 28                	jne    53d <printf+0x12a>
          s = "(null)";
 515:	be ef 06 00 00       	mov    $0x6ef,%esi
 51a:	8b 7d 08             	mov    0x8(%ebp),%edi
 51d:	eb 0d                	jmp    52c <printf+0x119>
          putc(fd, *s);
 51f:	0f be d2             	movsbl %dl,%edx
 522:	89 f8                	mov    %edi,%eax
 524:	e8 50 fe ff ff       	call   379 <putc>
          s++;
 529:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 52c:	0f b6 16             	movzbl (%esi),%edx
 52f:	84 d2                	test   %dl,%dl
 531:	75 ec                	jne    51f <printf+0x10c>
      state = 0;
 533:	be 00 00 00 00       	mov    $0x0,%esi
 538:	e9 02 ff ff ff       	jmp    43f <printf+0x2c>
 53d:	8b 7d 08             	mov    0x8(%ebp),%edi
 540:	eb ea                	jmp    52c <printf+0x119>
        putc(fd, *ap);
 542:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 545:	0f be 17             	movsbl (%edi),%edx
 548:	8b 45 08             	mov    0x8(%ebp),%eax
 54b:	e8 29 fe ff ff       	call   379 <putc>
        ap++;
 550:	83 c7 04             	add    $0x4,%edi
 553:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 556:	be 00 00 00 00       	mov    $0x0,%esi
 55b:	e9 df fe ff ff       	jmp    43f <printf+0x2c>
        putc(fd, c);
 560:	89 fa                	mov    %edi,%edx
 562:	8b 45 08             	mov    0x8(%ebp),%eax
 565:	e8 0f fe ff ff       	call   379 <putc>
      state = 0;
 56a:	be 00 00 00 00       	mov    $0x0,%esi
 56f:	e9 cb fe ff ff       	jmp    43f <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
 ...
 588:	a1 98 09 00 00       	mov    0x998,%eax
 58d:	eb 02                	jmp    591 <free+0x15>
 58f:	89 d0                	mov    %edx,%eax
 591:	39 c8                	cmp    %ecx,%eax
 593:	73 04                	jae    599 <free+0x1d>
 595:	39 08                	cmp    %ecx,(%eax)
 597:	77 12                	ja     5ab <free+0x2f>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 599:	8b 10                	mov    (%eax),%edx
 59b:	39 c2                	cmp    %eax,%edx
 59d:	77 f0                	ja     58f <free+0x13>
 59f:	39 c8                	cmp    %ecx,%eax
 5a1:	72 08                	jb     5ab <free+0x2f>
 5a3:	39 ca                	cmp    %ecx,%edx
 5a5:	77 04                	ja     5ab <free+0x2f>
 5a7:	89 d0                	mov    %edx,%eax
 5a9:	eb e6                	jmp    591 <free+0x15>
      break;
  if(bp + bp->s.size == p->s.ptr){
 5ab:	8b 73 fc             	mov    -0x4(%ebx),%esi
 5ae:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
 5b1:	8b 10                	mov    (%eax),%edx
 5b3:	39 d7                	cmp    %edx,%edi
 5b5:	74 19                	je     5d0 <free+0x54>
 ...
 5bd:	8d 34 d0             	lea    (%eax,%edx,8),%esi
 5c0:	39 ce                	cmp    %ecx,%esi
 5c2:	74 1b                	je     5df <free+0x63>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
 5c4:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5c6:	a3 98 09 00 00       	mov    %eax,0x998
}
 5cb:	5b                   	pop    %ebx
 5cc:	5e                   	pop    %esi
 5cd:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 5f3:	89 c3                	mov    %eax,%ebx
  ...
  if(nu < 4096)
 5f5:	3d ff 0f 00 00       	cmp    $0xfff,%eax
 5fa:	77 05                	ja     601 <morecore+0x15>
    nu = 4096;
 5fc:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
 601:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
 608:	83 ec 0c             	sub    $0xc,%esp
 60b:	50                   	push   %eax
 60c:	e8 20 fd ff ff       	call   331 <sbrk>
  if(p == (char*)-1)
 611:	83 c4 10             	add    $0x10,%esp
 614:	83 f8 ff             	cmp    $0xffffffff,%eax
 617:	74 1c                	je     635 <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 622:	50                   	push   %eax
 623:	e8 54 ff ff ff       	call   57c <free>
  return freep;
 628:	a1 98 09 00 00       	mov    0x998,%eax
 ...
 63a:	eb f4                	jmp    630 <morecore+0x44>
...
malloc(uint nbytes)
{
 ...
 646:	8d 58 07             	lea    0x7(%eax),%ebx
 649:	c1 eb 03             	shr    $0x3,%ebx
 64c:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 64f:	8b 0d 98 09 00 00    	mov    0x998,%ecx
 655:	85 c9                	test   %ecx,%ecx
 657:	74 04                	je     65d <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 659:	8b 01                	mov    (%ecx),%eax
 65b:	eb 4d                	jmp    6aa <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 65d:	c7 05 98 09 00 00 9c 	movl   $0x99c,0x998
 664:	09 00 00 
 667:	c7 05 9c 09 00 00 9c 	movl   $0x99c,0x99c
 66e:	09 00 00 
    base.s.size = 0;
 671:	c7 05 a0 09 00 00 00 	movl   $0x0,0x9a0
 678:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 67b:	b9 9c 09 00 00       	mov    $0x99c,%ecx
 680:	eb d7                	jmp    659 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 682:	39 da                	cmp    %ebx,%edx
 684:	74 1a                	je     6a0 <malloc+0x64>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 ...
 68e:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 691:	89 0d 98 09 00 00    	mov    %ecx,0x998
      return (void*)(p + 1);
 ...
 69a:	83 c4 04             	add    $0x4,%esp
 69d:	5b                   	pop    %ebx
 69e:	5d                   	pop    %ebp
 69f:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
 6a0:	8b 10                	mov    (%eax),%edx
 6a2:	89 11                	mov    %edx,(%ecx)
 6a4:	eb eb                	jmp    691 <malloc+0x55>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 6a6:	89 c1                	mov    %eax,%ecx
 6a8:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
 6aa:	8b 50 04             	mov    0x4(%eax),%edx
 6ad:	39 da                	cmp    %ebx,%edx
 6af:	73 d1                	jae    682 <malloc+0x46>
    if(p == freep)
 6b1:	39 05 98 09 00 00    	cmp    %eax,0x998
 6b7:	75 ed                	jne    6a6 <malloc+0x6a>
      if((p = morecore(nunits)) == 0)
 6b9:	89 d8                	mov    %ebx,%eax
 6bb:	e8 2c ff ff ff       	call   5ec <morecore>
 6c0:	85 c0                	test   %eax,%eax
 6c2:	75 e2                	jne    6a6 <malloc+0x6a>
        return 0;
 6c4:	b8 00 00 00 00       	mov    $0x0,%eax
 6c9:	eb cf                	jmp    69a <malloc+0x5e>
