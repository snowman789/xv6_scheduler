...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
   ...
   e:	68 70 0f 00 00       	push   $0xf70
  13:	6a 02                	push   $0x2
  15:	e8 9e 0c 00 00       	call   cb8 <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  54:	68 0d 10 00 00       	push   $0x100d
  59:	6a 02                	push   $0x2
  5b:	e8 58 0c 00 00       	call   cb8 <printf>
  exit();
...
00000084 <runcmd>:
{
  ...
  cc:	68 7f 0f 00 00       	push   $0xf7f
  d1:	6a 02                	push   $0x2
  d3:	e8 e0 0b 00 00       	call   cb8 <printf>
    break;
 ...
 10b:	68 8f 0f 00 00       	push   $0xf8f
 110:	6a 02                	push   $0x2
 112:	e8 a1 0b 00 00       	call   cb8 <printf>
      exit();
...
execcmd(void)
{
 ...
 231:	6a 54                	push   $0x54
 233:	e8 a9 0c 00 00       	call   ee1 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
 ...
 258:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 25b:	6a 18                	push   $0x18
 25d:	e8 7f 0c 00 00       	call   ee1 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
 ...
 2a0:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2a3:	6a 0c                	push   $0xc
 2a5:	e8 37 0c 00 00       	call   ee1 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
 ...
 2d6:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2d9:	6a 0c                	push   $0xc
 2db:	e8 01 0c 00 00       	call   ee1 <malloc>
...
backcmd(struct cmd *subcmd)
{
 ...
 30c:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 30f:	6a 08                	push   $0x8
 311:	e8 cb 0b 00 00       	call   ee1 <malloc>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
 ...
 35b:	50                   	push   %eax
 35c:	68 dc 15 00 00       	push   $0x15dc
 ...
 3dd:	50                   	push   %eax
 3de:	68 dc 15 00 00       	push   $0x15dc
 ...
 3f5:	50                   	push   %eax
 3f6:	68 d4 15 00 00       	push   $0x15d4
 ...
 432:	50                   	push   %eax
 433:	68 dc 15 00 00       	push   $0x15dc
...
peek(char **ps, char *es, char *toks)
{
 ...
 473:	50                   	push   %eax
 474:	68 dc 15 00 00       	push   $0x15dc
...
parseexec(char **ps, char *es)
{
 ...
 649:	68 c6 0f 00 00       	push   $0xfc6
 64e:	e8 f8 f9 ff ff       	call   4b <panic>
      panic("too many args");
 653:	83 ec 0c             	sub    $0xc,%esp
 656:	68 cd 0f 00 00       	push   $0xfcd
...
00000764 <parseblock>:
{
 ...
 7a0:	68 00 10 00 00       	push   $0x1000
 7a5:	56                   	push   %esi
 7a6:	53                   	push   %ebx
...
00000882 <parsecmd>:
{
 ...
 8d5:	50                   	push   %eax
 8d6:	68 02 10 00 00       	push   $0x1002
 8db:	6a 02                	push   $0x2
 8dd:	e8 d6 03 00 00       	call   cb8 <printf>
    panic("syntax");
 8e2:	c7 04 24 c6 0f 00 00 	movl   $0xfc6,(%esp)
...
000008ee <main>:
{
 ...
 902:	6a 02                	push   $0x2
 904:	68 11 10 00 00       	push   $0x1011
 ...
 939:	6a 64                	push   $0x64
 93b:	68 00 16 00 00       	push   $0x1600
 940:	e8 bb f6 ff ff       	call   0 <getcmd>
 945:	83 c4 10             	add    $0x10,%esp
 948:	85 c0                	test   %eax,%eax
 94a:	78 70                	js     9bc <main+0xce>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
 94c:	80 3d 00 16 00 00 63 	cmpb   $0x63,0x1600
 953:	75 d3                	jne    928 <main+0x3a>
 955:	80 3d 01 16 00 00 64 	cmpb   $0x64,0x1601
 95c:	75 ca                	jne    928 <main+0x3a>
 95e:	80 3d 02 16 00 00 20 	cmpb   $0x20,0x1602
 965:	75 c1                	jne    928 <main+0x3a>
      buf[strlen(buf)-1] = 0;  // chop \n
 967:	83 ec 0c             	sub    $0xc,%esp
 96a:	68 00 16 00 00       	push   $0x1600
 96f:	e8 91 00 00 00       	call   a05 <strlen>
 974:	c6 80 ff 15 00 00 00 	movb   $0x0,0x15ff(%eax)
      if(chdir(buf+3) < 0)
 97b:	c7 04 24 03 16 00 00 	movl   $0x1603,(%esp)
 ...
 991:	68 03 16 00 00       	push   $0x1603
 996:	68 19 10 00 00       	push   $0x1019
 99b:	6a 02                	push   $0x2
 99d:	e8 16 03 00 00       	call   cb8 <printf>
 9a2:	83 c4 10             	add    $0x10,%esp
      continue;
 9a5:	eb 8f                	jmp    936 <main+0x48>
      runcmd(parsecmd(buf));
 9a7:	83 ec 0c             	sub    $0xc,%esp
 9aa:	68 00 16 00 00       	push   $0x1600
...
putc(int fd, char c)
{
 ...
 c21:	83 ec 1c             	sub    $0x1c,%esp
 c24:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
 c27:	6a 01                	push   $0x1
 c29:	8d 55 f4             	lea    -0xc(%ebp),%edx
 c2c:	52                   	push   %edx
 c2d:	50                   	push   %eax
 c2e:	e8 3b ff ff ff       	call   b6e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 c3c:	56                   	push   %esi
 c3d:	53                   	push   %ebx
 c3e:	83 ec 2c             	sub    $0x2c,%esp
 c41:	89 c7                	mov    %eax,%edi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
 c43:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 c47:	0f 95 c3             	setne  %bl
 c4a:	89 d0                	mov    %edx,%eax
 c4c:	c1 e8 1f             	shr    $0x1f,%eax
 c4f:	84 c3                	test   %al,%bl
 c51:	74 10                	je     c63 <printint+0x2b>
    neg = 1;
    x = -xx;
 c53:	f7 da                	neg    %edx
    neg = 1;
 c55:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }
 ...
 c61:	eb 0b                	jmp    c6e <printint+0x36>
  neg = 0;
 c63:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 c6a:	eb f0                	jmp    c5c <printint+0x24>
  do{
    buf[i++] = digits[x % base];
 c6c:	89 c6                	mov    %eax,%esi
 c6e:	89 d0                	mov    %edx,%eax
 c70:	ba 00 00 00 00       	mov    $0x0,%edx
 c75:	f7 f1                	div    %ecx
 c77:	89 c3                	mov    %eax,%ebx
 c79:	8d 46 01             	lea    0x1(%esi),%eax
 c7c:	0f b6 92 60 10 00 00 	movzbl 0x1060(%edx),%edx
 c83:	88 54 35 d8          	mov    %dl,-0x28(%ebp,%esi,1)
  }while((x /= base) != 0);
 c87:	89 da                	mov    %ebx,%edx
 c89:	85 db                	test   %ebx,%ebx
 c8b:	75 df                	jne    c6c <printint+0x34>
 c8d:	89 c3                	mov    %eax,%ebx
  if(neg)
 c8f:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 c93:	74 16                	je     cab <printint+0x73>
    buf[i++] = '-';
 c95:	c6 44 05 d8 2d       	movb   $0x2d,-0x28(%ebp,%eax,1)
 c9a:	8d 5e 02             	lea    0x2(%esi),%ebx
 c9d:	eb 0c                	jmp    cab <printint+0x73>

  while(--i >= 0)
    putc(fd, buf[i]);
 c9f:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 ca4:	89 f8                	mov    %edi,%eax
 ca6:	e8 73 ff ff ff       	call   c1e <putc>
  while(--i >= 0)
 cab:	83 eb 01             	sub    $0x1,%ebx
 cae:	79 ef                	jns    c9f <printint+0x67>
}
 cb0:	83 c4 2c             	add    $0x2c,%esp
 cb3:	5b                   	pop    %ebx
 cb4:	5e                   	pop    %esi
 cb5:	5f                   	pop    %edi
 cb6:	5d                   	pop    %ebp
...
printf(int fd, const char *fmt, ...)
{
 ...
 cbe:	83 ec 1c             	sub    $0x1c,%esp
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
 cc1:	8d 45 10             	lea    0x10(%ebp),%eax
 cc4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
 cc7:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
 ccc:	bb 00 00 00 00       	mov    $0x0,%ebx
 cd1:	eb 14                	jmp    ce7 <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
 cd3:	89 fa                	mov    %edi,%edx
 cd5:	8b 45 08             	mov    0x8(%ebp),%eax
 cd8:	e8 41 ff ff ff       	call   c1e <putc>
 cdd:	eb 05                	jmp    ce4 <printf+0x2c>
      }
    } else if(state == '%'){
 cdf:	83 fe 25             	cmp    $0x25,%esi
 ce2:	74 25                	je     d09 <printf+0x51>
  for(i = 0; fmt[i]; i++){
 ce4:	83 c3 01             	add    $0x1,%ebx
 ce7:	8b 45 0c             	mov    0xc(%ebp),%eax
 cea:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 cee:	84 c0                	test   %al,%al
 cf0:	0f 84 23 01 00 00    	je     e19 <printf+0x161>
    c = fmt[i] & 0xff;
 cf6:	0f be f8             	movsbl %al,%edi
 cf9:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 cfc:	85 f6                	test   %esi,%esi
 cfe:	75 df                	jne    cdf <printf+0x27>
      if(c == '%'){
 d00:	83 f8 25             	cmp    $0x25,%eax
 d03:	75 ce                	jne    cd3 <printf+0x1b>
        state = '%';
 d05:	89 c6                	mov    %eax,%esi
 d07:	eb db                	jmp    ce4 <printf+0x2c>
      if(c == 'd'){
 d09:	83 f8 64             	cmp    $0x64,%eax
 d0c:	74 49                	je     d57 <printf+0x9f>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 d0e:	83 f8 78             	cmp    $0x78,%eax
 d11:	0f 94 c1             	sete   %cl
 d14:	83 f8 70             	cmp    $0x70,%eax
 d17:	0f 94 c2             	sete   %dl
 d1a:	08 d1                	or     %dl,%cl
 d1c:	75 63                	jne    d81 <printf+0xc9>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 d1e:	83 f8 73             	cmp    $0x73,%eax
 d21:	0f 84 84 00 00 00    	je     dab <printf+0xf3>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 d27:	83 f8 63             	cmp    $0x63,%eax
 d2a:	0f 84 b7 00 00 00    	je     de7 <printf+0x12f>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 d30:	83 f8 25             	cmp    $0x25,%eax
 d33:	0f 84 cc 00 00 00    	je     e05 <printf+0x14d>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
 d39:	ba 25 00 00 00       	mov    $0x25,%edx
 d3e:	8b 45 08             	mov    0x8(%ebp),%eax
 d41:	e8 d8 fe ff ff       	call   c1e <putc>
        putc(fd, c);
 d46:	89 fa                	mov    %edi,%edx
 d48:	8b 45 08             	mov    0x8(%ebp),%eax
 d4b:	e8 ce fe ff ff       	call   c1e <putc>
      }
      state = 0;
 d50:	be 00 00 00 00       	mov    $0x0,%esi
 d55:	eb 8d                	jmp    ce4 <printf+0x2c>
        printint(fd, *ap, 10, 1);
 d57:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 d5a:	8b 17                	mov    (%edi),%edx
 d5c:	83 ec 0c             	sub    $0xc,%esp
 d5f:	6a 01                	push   $0x1
 d61:	b9 0a 00 00 00       	mov    $0xa,%ecx
 d66:	8b 45 08             	mov    0x8(%ebp),%eax
 d69:	e8 ca fe ff ff       	call   c38 <printint>
        ap++;
 ...
 d7c:	e9 63 ff ff ff       	jmp    ce4 <printf+0x2c>
        printint(fd, *ap, 16, 0);
 d81:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 d84:	8b 17                	mov    (%edi),%edx
 d86:	83 ec 0c             	sub    $0xc,%esp
 d89:	6a 00                	push   $0x0
 d8b:	b9 10 00 00 00       	mov    $0x10,%ecx
 d90:	8b 45 08             	mov    0x8(%ebp),%eax
 d93:	e8 a0 fe ff ff       	call   c38 <printint>
        ap++;
 d98:	83 c7 04             	add    $0x4,%edi
 d9b:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 d9e:	83 c4 10             	add    $0x10,%esp
      state = 0;
 da1:	be 00 00 00 00       	mov    $0x0,%esi
 da6:	e9 39 ff ff ff       	jmp    ce4 <printf+0x2c>
        s = (char*)*ap;
 dab:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 dae:	8b 30                	mov    (%eax),%esi
        ap++;
 db0:	83 c0 04             	add    $0x4,%eax
 db3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 db6:	85 f6                	test   %esi,%esi
 db8:	75 28                	jne    de2 <printf+0x12a>
          s = "(null)";
 dba:	be 58 10 00 00       	mov    $0x1058,%esi
 dbf:	8b 7d 08             	mov    0x8(%ebp),%edi
 dc2:	eb 0d                	jmp    dd1 <printf+0x119>
          putc(fd, *s);
 dc4:	0f be d2             	movsbl %dl,%edx
 dc7:	89 f8                	mov    %edi,%eax
 dc9:	e8 50 fe ff ff       	call   c1e <putc>
          s++;
 dce:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 dd1:	0f b6 16             	movzbl (%esi),%edx
 dd4:	84 d2                	test   %dl,%dl
 dd6:	75 ec                	jne    dc4 <printf+0x10c>
      state = 0;
 dd8:	be 00 00 00 00       	mov    $0x0,%esi
 ddd:	e9 02 ff ff ff       	jmp    ce4 <printf+0x2c>
 de2:	8b 7d 08             	mov    0x8(%ebp),%edi
 de5:	eb ea                	jmp    dd1 <printf+0x119>
        putc(fd, *ap);
 de7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 dea:	0f be 17             	movsbl (%edi),%edx
 ded:	8b 45 08             	mov    0x8(%ebp),%eax
 df0:	e8 29 fe ff ff       	call   c1e <putc>
        ap++;
 df5:	83 c7 04             	add    $0x4,%edi
 df8:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 dfb:	be 00 00 00 00       	mov    $0x0,%esi
 e00:	e9 df fe ff ff       	jmp    ce4 <printf+0x2c>
        putc(fd, c);
 e05:	89 fa                	mov    %edi,%edx
 e07:	8b 45 08             	mov    0x8(%ebp),%eax
 e0a:	e8 0f fe ff ff       	call   c1e <putc>
      state = 0;
 e0f:	be 00 00 00 00       	mov    $0x0,%esi
 e14:	e9 cb fe ff ff       	jmp    ce4 <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
 ...
 e2d:	a1 64 16 00 00       	mov    0x1664,%eax
 ...
 e69:	89 08                	mov    %ecx,(%eax)
  freep = p;
 e6b:	a3 64 16 00 00       	mov    %eax,0x1664
}
 e70:	5b                   	pop    %ebx
 e71:	5e                   	pop    %esi
 e72:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 ec8:	e8 54 ff ff ff       	call   e21 <free>
  return freep;
 ecd:	a1 64 16 00 00       	mov    0x1664,%eax
...
malloc(uint nbytes)
{
 ...
 ef1:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 ef4:	8b 0d 64 16 00 00    	mov    0x1664,%ecx
 ...
 f00:	eb 4d                	jmp    f4f <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 f02:	c7 05 64 16 00 00 68 	movl   $0x1668,0x1664
 f09:	16 00 00 
 f0c:	c7 05 68 16 00 00 68 	movl   $0x1668,0x1668
 f13:	16 00 00 
    base.s.size = 0;
 f16:	c7 05 6c 16 00 00 00 	movl   $0x0,0x166c
 f1d:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 f20:	b9 68 16 00 00       	mov    $0x1668,%ecx
 f25:	eb d7                	jmp    efe <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 f27:	39 da                	cmp    %ebx,%edx
 f29:	74 1a                	je     f45 <malloc+0x64>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 f2b:	29 da                	sub    %ebx,%edx
 f2d:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 f30:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
 f33:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
 f36:	89 0d 64 16 00 00    	mov    %ecx,0x1664
      return (void*)(p + 1);
 ...
 f44:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
 f45:	8b 10                	mov    (%eax),%edx
 f47:	89 11                	mov    %edx,(%ecx)
 f49:	eb eb                	jmp    f36 <malloc+0x55>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f4b:	89 c1                	mov    %eax,%ecx
 f4d:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
 f4f:	8b 50 04             	mov    0x4(%eax),%edx
 f52:	39 da                	cmp    %ebx,%edx
 f54:	73 d1                	jae    f27 <malloc+0x46>
    if(p == freep)
 f56:	39 05 64 16 00 00    	cmp    %eax,0x1664
 f5c:	75 ed                	jne    f4b <malloc+0x6a>
      if((p = morecore(nunits)) == 0)
 f5e:	89 d8                	mov    %ebx,%eax
 f60:	e8 2c ff ff ff       	call   e91 <morecore>
 f65:	85 c0                	test   %eax,%eax
 f67:	75 e2                	jne    f4b <malloc+0x6a>
        return 0;
 f69:	b8 00 00 00 00       	mov    $0x0,%eax
 f6e:	eb cf                	jmp    f3f <malloc+0x5e>
