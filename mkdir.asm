...
printint(int fd, int xx, int base, int sgn)
{
 ...
 32c:	0f b6 92 5c 06 00 00 	movzbl 0x65c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 468:	75 28                	jne    492 <printf+0x12a>
          s = "(null)";
 46a:	be 53 06 00 00       	mov    $0x653,%esi
...
free(void *ap)
{
 ...
 4dd:	a1 00 09 00 00       	mov    0x900,%eax
 ...
 519:	89 08                	mov    %ecx,(%eax)
  freep = p;
 51b:	a3 00 09 00 00       	mov    %eax,0x900
}
 520:	5b                   	pop    %ebx
 521:	5e                   	pop    %esi
 522:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 578:	e8 54 ff ff ff       	call   4d1 <free>
  return freep;
 57d:	a1 00 09 00 00       	mov    0x900,%eax
...
malloc(uint nbytes)
{
 ...
 5a1:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5a4:	8b 0d 00 09 00 00    	mov    0x900,%ecx
 ...
 5b0:	eb 4d                	jmp    5ff <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 5b2:	c7 05 00 09 00 00 04 	movl   $0x904,0x900
 5b9:	09 00 00 
 5bc:	c7 05 04 09 00 00 04 	movl   $0x904,0x904
 5c3:	09 00 00 
    base.s.size = 0;
 5c6:	c7 05 08 09 00 00 00 	movl   $0x0,0x908
 5cd:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5d0:	b9 04 09 00 00       	mov    $0x904,%ecx
 ...
 5e3:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5e6:	89 0d 00 09 00 00    	mov    %ecx,0x900
      return (void*)(p + 1);
 ...
 604:	73 d1                	jae    5d7 <malloc+0x46>
    if(p == freep)
 606:	39 05 00 09 00 00    	cmp    %eax,0x900
